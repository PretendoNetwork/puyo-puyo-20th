...
func registerCommonAuthenticationServerProtocols() {
	...
	secureStationURL.SetAddress(os.Getenv("PN_PP20_SECURE_SERVER_HOST"))
	...
	commonTicketGrantingProtocol.BuildName = types.NewString("shigu! shigu! shigu!")
	...
	if globals.LocalAuthMode {
		...
		commonTicketGrantingProtocol.ConfigurePNValidation([]string{"00056600"})
	}
}
